...
<head>
    ...
    <!-- Site Icons -->
    <link rel="shortcut icon" href="{{url('public')}}/frontend/images/favicon.ico" type="image/x-icon" />
    <link rel="apple-touch-icon" href="{{url('public')}}/frontend/images/apple-touch-icon.png">

    <!-- Bootstrap CSS -->
    <link rel="stylesheet" href="{{url('public')}}/frontend/css/bootstrap.min.css">
    <!-- Site {{url('public')}}/frontend/CSS -->
    <link rel="stylesheet" href="{{url('public')}}/frontend/css/style.css">
    <!-- Responsive {{url('public')}}/frontend/CSS -->
    <link rel="stylesheet" href="{{url('public')}}/frontend/css/responsive.css">
    <!-- color -->
    <link id="changeable-colors" rel="stylesheet" href="{{url('public')}}/frontend/css/colors/orange.css" />

    <!-- Modernizer -->
    <script src="{{('public')}}/frontend/js/modernizer.js"></script>
...
<body>
    ...
    <div id="about" class="about-main pad-top-100 pad-bottom-100">
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                    <div class="wow fadeIn" data-wow-duration="1s" data-wow-delay="0.1s">
                        <div class="about-{{('public')}}/frontend/images">
    ...
    <div id="footer" class="footer-main">
        <div class="footer-news pad-top-100 pad-bottom-70 parallax">
         ...
         <section id="contact">
            <div class="map">
            <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3834.652533201625!2d108.2108955140077!3d16.031593444705752!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x314219e9f58952c7%3A0x2698795a4e951139!2sMr.Beer%20Food%20%26%20Beer!5e0!3m2!1svi!2s!4v1680766447129!5m2!1svi!2s" 
    ...
    <!-- ALL JS FILES -->
    <script src="{{('public')}}/frontend/js/all.js"></script>
